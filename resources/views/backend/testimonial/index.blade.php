                ...
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        <form method="GET" class="navbar-form search-form page-search">
                                <input name="con_name" value="{{ $request->title }}" class="form-control" placeholder="Search here..." type="text">
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($testimonials as $key => $testimonial)
                                            ...
                                            <tr>
                                                    ...
                                                    <td>{{ str_limit($testimonial->title,'10') }}</td>
                                                    <td>{{ $testimonial->designation }}</td>
                                                    <td>{{ $testimonial->created_at }}</td>

                                                <td>
                                                    <a href="{!! route('testimonial.edit', $testimonial->id ) !!}" type="button" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                                    {{-- <a href="" class="button" data-id="{{$slider->id}}">Delete</a> --}}

                                                    <button type="button"  data-id="{{$testimonial->id}}" class="btn-delete btn btn-danger js-sweetalert" title="Delete"><i class="fa fa-trash-o"></i></button>

                                                    {{ Form::open(['route' => ['testimonial.destroy', $testimonial->id], 'method' => 'DELETE', 'id' =>  $testimonial->id]) }}
