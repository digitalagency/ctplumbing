...
<div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                            <form method="GET" class="navbar-form search-form user-search">
                                        ...
                                        <tbody>
                                          ...
                                          @foreach ($users as $key => $user)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="{!! route('user.edit', $user->id ) !!}" type="button" class="btn btn-info" title="Edit"><i class="fa fa-edit"></i></a>
                                                    {{-- <a href="" class="button" data-id="{{$user->id}}">Delete</a> --}}

                                                    <button type="button"  data-id="{{$user->id}}" class="btn-delete btn btn-danger js-sweetalert" title="Delete"><i class="fa fa-trash-o"></i></button>

                                                    {{ Form::open(['route' => ['user.destroy', $user->id], 'method' => 'DELETE', 'id' =>  $user->id]) }}
