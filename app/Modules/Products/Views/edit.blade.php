...
<div class="row clearfix">
    ...
    <div class="col-lg-3 col-md-12">
        <div class="card">
         ...
         @if($data->image)
         {!! Form::file('image[]', [ 'id'=>'dropify-event', multiple,'data-default-file' => asset('uploads/images/'.$data->image) ]) !!}
           <input id="image" type="hidden" name="image" value="{{ $image }}" >
         @else
            {!! Form::file('image[]', [ 'id'=>'dropify-event', multiple,'data-default-file' => asset('uploads/images/'.$data->images->first()->image) ]) !!}
           <input id="image" type="hidden" name="image" value="{{ $image }}" >
           @endif
        ...
        <div class="card cardCat">
                ...
                @if ($errors->has('category_id')) <p class="help-block m-b-none">{{ $errors->first('category_id') }}</p> @endif
             </div>
           </div>
