...
<div class="block-header">
                <div class="row">
                    ...
                    <div class="col-lg-7 col-md-4 col-sm-12 text-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('indexSlider') }}"><i class="icon-home"></i></a></li>
            ...
            $image = '';
            @endphp
            <form  method="post" class=""  action="{{ route('updateSlider',['id'=>$data->id]) }}"   enctype='multipart/form-data' >
            @csrf
                    ...
                    <div class="card">
                        <div class="body">
                          ...
                          <div class="col-md-6 form-group{{ $errors->has('title') ? ' has-error' : '' }}">
                              ...
                              <input type="text" class="form-control" value="{{$data->title}}" name="title" value="{{ old('title') }}"/>
                          ...
                          <div class="col-md-6 form-group{{ $errors->has('position') ? ' has-error' : '' }}">
                              ...
                              <select name="position" class="form-control position">
                                    <option {{old('position','first')==$data->position? 'selected':''}} value="first" >First</option>
                                    <option {{old('position','second')==$data->position? 'selected':''}} value="second" >Second</option>
                                    <option {{old('position','third')==$data->position? 'selected':''}} value="third" >Third</option>
                                </select>
