...
class CtplumbingController extends Controller
{
    ...
    {
        $products = $this->product->orderBy('id', 'asc')->take(4)->get();

        $topcategpries = $this->product->orderBy('id', 'asc')->get();
        ...
        $promotions = Products::orderBy('id', 'asc')->take(3)->get();
        //dd($promotions);
    ...
    {
        $newest  = \DB::table('products')->orderBy('id', 'DESC')->paginate(4);
    ...
    {
        $products  = \DB::table('products')->orderBy('discount', 'DESC')->paginate(4);
    }

    public function sortByPriceHighToLow()
    {
        $products  = \DB::table('products')->orderBy('discount', 'ASC')->paginate(4);
    }
