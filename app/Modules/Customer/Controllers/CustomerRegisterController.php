...
*/
    public function register(CustomerRegisterRequest $request)
    {
        ...
        if ($existing_customer > 0) {
            ...
            return redirect()->route('customer/register')->with('message', 'Email already used');
        ...
        return redirect()->route('customer/register')->with('success', 'Sign Up Success! Please check your email for links and verification');
